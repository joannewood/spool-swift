...
struct SpoolApp: App {
    ...
    var body: some Scene {
        ...
        // Spool's own mark (generated by Tools/IconGenerator/generate_icon.swift), not
        // a generic SF Symbol — `MenuBarIcon` is a template image (see its Contents.json),
        // so macOS recolors it automatically for light/dark menu bars.
